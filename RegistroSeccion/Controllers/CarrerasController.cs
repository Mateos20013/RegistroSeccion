...
namespace RegistroSeccion.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public CarrerasController(RegistroSeccionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCarrera,Nombre")] Carrera carrera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCarrera,Nombre")] Carrera carrera)
        {
